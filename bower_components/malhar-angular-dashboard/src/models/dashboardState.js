...
angular.module('ui.dashboard')
  .factory('DashboardState', ['$log', '$q', 'dbService', function ($log, $q, dbService) {
    ...
    DashboardState.prototype = {
      ...
      loadFromDb: function(dashboardid){
          var self = this;
          var deferred = $q.defer();
          dbService.getDashboard(dashboardid).then(function(response){
              var savedWidgetDefs = response.widgets;
              var result = [];
              ...
              for (var i = 0; i < savedWidgetDefs.length; i++) {
                  ...
                  var widgetDefinition = self.widgetDefinitions.getByName(savedWidgetDef.name);
